    ...
    <div className={cn('grid gap-6', className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-muted-foreground text-sm text-balance">
          Sign in to your Omnibot account to manage your communications
        </p>
      </div>

      {/* Registration Success Banner */}
      {showRegistrationSuccess && (
        <div className="bg-success/10 border border-success/20 rounded-lg p-4 animate-in slide-in-from-top-2 duration-300">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4" autoComplete="off">
          ...
          <Button 
            type="submit" 
            className="w-full bg-brand hover:bg-brand/90 text-brand-foreground font-medium h-11 mt-2" 
      ...
      <div className="bg-muted/30 rounded-lg p-4 space-y-3">
        <div className="flex items-center gap-2">
          <svg className="h-4 w-4 text-info" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
          </svg>
          <h4 className="text-sm font-medium">Quick Demo Access</h4>
        </div>
        <div className="grid grid-cols-1 gap-2 text-xs">
          <div className="flex justify-between items-center p-2 bg-background/50 rounded border">
            <span className="text-muted-foreground">Demo Owner:</span>
            <code className="text-role-owner font-mono">owner@demo.com</code>
          </div>
          <div className="flex justify-between items-center p-2 bg-background/50 rounded border">
            <span className="text-muted-foreground">Demo Admin:</span>
            <code className="text-role-admin font-mono">admin@demo.com</code>
          </div>
